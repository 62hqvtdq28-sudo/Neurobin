    ...
    return `
      <div class="product-card-main scroll-animate-scale" role="listitem" data-category="${safeCategory}" data-id="${safeId}">
        ...
        <div class="product-image-wrapper cursor-pointer" onclick="openQuickView('${safeId}')">
          ${product.image
            ? `<img src="${SecurityValidator.escapeHtml(product.image)}" alt="" class="w-full h-full object-cover" loading="lazy">`
...
function openQuickView(productId) {
  ...
  content.innerHTML = `
    ${product.image
      ? `<div class="h-64 overflow-hidden"><img src="${SecurityValidator.escapeHtml(product.image)}" alt="" class="w-full h-full object-cover" loading="lazy"></div>`
