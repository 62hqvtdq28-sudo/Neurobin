...
function renderMoSelectedProducts() {
  ...
  for (var i = 0; i < _moCartItems.length; i++) {
    ...
    html += '<div class="flex items-center gap-1.5 bg-white rounded-xl px-2 py-2 border border-brand-100">'
      ...
      +   '<button onclick="changeMoQty(' + "'" + pid + "'" + ',-1)" style="width:26px;height:26px;min-width:26px" class="flex items-center justify-center bg-brand-100 hover:bg-red-100 text-brand-700 hover:text-red-600 rounded-lg text-base font-bold leading-none transition-colors">-</button>'
      +   '<input type="number" class="mo-item-qty text-xs text-center border border-brand-200 rounded-lg" style="width:38px;height:26px;padding:0 2px;-moz-appearance:textfield;text-align:center" value="' + item.qty + '" min="1" max="99" data-pid="' + pid + '" oninput="updateMoItemQty(this)">'
      +   '<button onclick="changeMoQty(' + "'" + pid + "'" + ',1)" style="width:26px;height:26px;min-width:26px" class="flex items-center justify-center bg-brand-100 hover:bg-green-100 text-brand-700 hover:text-green-600 rounded-lg text-base font-bold leading-none transition-colors">+</button>'
      + '</div>'
      + '<input type="number" class="mo-item-price text-xs text-center border border-brand-200 rounded-lg" style="width:64px;height:26px;padding:0 4px;-moz-appearance:textfield" value="' + item.price + '" min="0" step="250" data-pid="' + pid + '" oninput="updateMoItemPrice(this)">'
